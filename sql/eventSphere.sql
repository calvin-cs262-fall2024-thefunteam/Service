...
INSERT INTO Account (ID, Accountname, password, name) VALUES (1,'Account1', 'password1', 'name 1');
INSERT INTO Account (ID, Accountname, password, name) VALUES (2, 'Account2', 'password2', 'name 2');
INSERT INTO Account (ID, Accountname, password, name) VALUES (3, 'Account3', 'password3', 'name 3');


-- Insert sample Events
INSERT INTO Events (ID, name, location, date, time, description, tagsArray, organizerID) VALUES
